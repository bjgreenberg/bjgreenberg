...
* **featured:** vendor-dashboard joins the featured projects — pin cards generalized to a list ([1a31a96](https://github.com/bjgreenberg/bjgreenberg/commit/1a31a96858ae780e0fb1ea15c158d12b0f7d0cdb))


### Bug Fixes

* **featured:** captions render under their own cards, emitted by the generator so they cannot drift ([443d36e](https://github.com/bjgreenberg/bjgreenberg/commit/443d36ee13ed9a5729ce7179b6b3eab3e135fc7f))
* **hardening:** cap feed/status-API reads, silence bandit comment mis-parse, serialize workflow runs ([cf2a0ac](https://github.com/bjgreenberg/bjgreenberg/commit/cf2a0acf9ddcce7362b7dc2f0d8b862e05292aa0))
...
* **security:** escape feed URLs in README href attributes and refuse non-http(s) permalinks ([8ac3b72](https://github.com/bjgreenberg/bjgreenberg/commit/8ac3b72cb6976820d987fcb8fecfe183ce7ee3b3))
